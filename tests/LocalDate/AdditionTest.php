...
final class AdditionTest extends TestCase
{
    ...
    {
        $date = LocalDate::of(1975)->plus(years: 2);
        self::assertInstanceOf(LocalDate::class, $date);
        self::assertSame(1977, $date->year());
    ...
    public function testAddYearsPositive(): void
    {
        ...
        self::assertSame(1977, $date->plus(years: 2)->year());
        self::assertSame(1977, $date->plus(Period::of(years: 2))->year());
    }

    public function testAddYearsZero(): void
    {
        $date = LocalDate::of(1975);
        self::assertSame(1975, $date->plus(years: 0)->year());
        self::assertSame(1975, $date->plus(Period::of(years: 0))->year());
    }

    public function testAddYearsNegative(): void
    {
        $date = LocalDate::of(1975);
        self::assertSame(1973, $date->plus(years: -2)->year());
        self::assertSame(1973, $date->plus(Period::of(years: -2))->year());
    }
    ...
    public function testAddMonthsPositive(): void
    {
        ...
        self::assertSame(8, $date->plus(months: 2)->month());
        self::assertSame(8, $date->plus(Period::of(months: 2))->month());
    }

    public function testAddMonthsZero(): void
    {
        $date = LocalDate::of(1975, 6);
        self::assertSame(6, $date->plus(months: 0)->month());
        self::assertSame(6, $date->plus(Period::of(months: 0))->month());
    }

    public function testAddMonthsNegative(): void
    {
        $date = LocalDate::of(1975, 6);
        self::assertSame(4, $date->plus(months: -2)->month());
        self::assertSame(4, $date->plus(Period::of(months: -2))->month());
    }
    ...
    {
        $date = LocalDate::of(1975, 5, 31);
        self::assertSame(31, $date->plus(days: 0)->day());
        self::assertSame(31, $date->plus(Period::of(days: 0))->day());
    }

    public function testAddDaysNegative(): void
    {
        $date = LocalDate::of(1975, 5, 31);
        self::assertSame(29, $date->plus(days: -2)->day());
        self::assertSame(29, $date->plus(Period::of(days: -2))->day());
    }
}
