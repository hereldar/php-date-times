...
final class SubtractionTest extends TestCase
{
    ...
    public function testSubtractYearsOverflow(): void
    {
        ...
        self::assertDateTime($date->minus(years: 2), 2014, 2, 28);
        self::assertDateTime($date->minus(Period::of(years: 2)), 2014, 2, 28);
        self::assertDateTime($date->minus(years: 2, overflow: true), 2014, 3, 1);
        self::assertDateTime($date->minus(Period::of(years: 2), overflow: true), 2014, 3, 1);

        $date = DateTime::fromIso8601('2008-02-29T00:00:00Z');
        self::assertDateTime($date->minus(years: 1, weeks: 1), 2007, 2, 21);
        self::assertDateTime($date->minus(Period::of(years: 1, weeks: 1)), 2007, 2, 21);
        self::assertDateTime($date->minus(years: 1, weeks: 1, overflow: true), 2007, 2, 22);
        self::assertDateTime($date->minus(Period::of(years: 1, weeks: 1), overflow: true), 2007, 2, 22);
    }
    ...
    {
        $date = DateTime::fromIso8601('2021-03-31T00:00:00Z');
        self::assertDateTime($date->minus(months: 1), 2021, 2, 28);
        self::assertDateTime($date->minus(Period::of(months: 1)), 2021, 2, 28);
        self::assertDateTime($date->minus(months: 1, overflow: true), 2021, 3, 3);
        self::assertDateTime($date->minus(Period::of(months: 1), overflow: true), 2021, 3, 3);

        $date = DateTime::fromIso8601('2007-03-31T00:00:00Z');
        self::assertDateTime($date->minus(months: 1, weeks: 1), 2007, 2, 21);
        self::assertDateTime($date->minus(Period::of(months: 1, weeks: 1)), 2007, 2, 21);
        self::assertDateTime($date->minus(months: 1, weeks: 1, overflow: true), 2007, 2, 24);
        self::assertDateTime($date->minus(Period::of(months: 1, weeks: 1), overflow: true), 2007, 2, 24);
    }
